<%-- 
    Document   : usuario
    Created on : 9/10/2024, 09:13:32 PM
    Author     : florc
--%>
...
<html>
            ...
            function startTimer() {
                ...
                const interval = setInterval(function() {
                    ...
                    if (--remainingTime < 0) {
                        ...
                        alert("Tu sesión ha expirado. Seras redirigido a la página de login.");
    ...
    <body>
        ...
        <% if(matricula != null){ %>
                ...
                <a href="${pageContext.request.contextPath}/loginServelet">Cerrar Sesion</a>
        <% } else {%>
